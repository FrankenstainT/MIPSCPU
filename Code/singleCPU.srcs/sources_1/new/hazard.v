...
module hazard(
	...
	output forwardrdM,input[4:0] rtM,input memtoregW,is_mfc0E,output forwardcp0E,input[4:0]rdE,rdM
    );
	...
	assign #1 flushE = ((lwstallD | branchD & ~balD | jumpD & ~jalD) & ~stallE)|flush_except;// |jumpD added
